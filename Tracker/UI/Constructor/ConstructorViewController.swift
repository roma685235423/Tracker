...
private extension ConstructorViewController {
    ...
    func shortWeekDaysNamesCreation(schedule: [DayOfWeek]?) -> String {
    ...
    func configureTableHeight() -> CGFloat {
    ...
    func textLimitLabelIs(visible: Bool) {
    ...
    func isNeedToAddSchedulerAction() {
    ...
    func isNeedToSelectEmoji(for indexPath: IndexPath) -> Bool {
        emojies[indexPath.row] == tracker.emoji ? true : false
    }
    
    func isNeedToSelectColor(for indexPath: IndexPath) -> Bool {
    ...
    @objc
    func hideKeyboardAndSaveTextFieldValue() {
